export default {
  static: {
    home: {
      ...
      explore: {
        title: "Explore trending categories on Reevas",
        description:
          "Check what popular on Reevas and make project look trendy and profesional",
      },
      unlock: {
      ...
      advantages: {
        ...
        description:
          "whether you`re looking for designs or photographs, you`ll find the perfect asset on Reevas",
        items: [
          {
      ...
      bannerBottom: {
        ...
        description:
          "Behind every stock image, there`s creative mind You can also create content and sell it on Reevas",
        button: "Sell content",
      },
    },
    catalog: {
    ...
    about: {
      ...
      bannerUnlimited: {
        ...
        description:
          "Your imagination has no limits, neither do the possibilities we offer. Reevas Company comprises three engaging projects.",
        button: "Learn more",
      },
      origins: {
        title: "The origins of our Reevas Universe",
        description: [
          "Our first project, Reevas, was founded in 2010 by brothers Alejandro and Pablo Blanes, along with their friend Joaquín Cuenca, founder of Panoramio (acquired by Google).",
          "Alejandro felt the urge to create a platform where designers could find free graphic resources. Pablo and Joaquín supported his idea and that’s how Reevas Company was created.",
          "Since then, our Universe has been expanding non-stop, creating two new projects: Flaticon and Slidesgo.",
        ],
      },
      companies: "Companies that use Reevas Company’s resources",
      timeline: {
        title: "",
        items: [
          {
          ...
          {
            year: "2015",
            text: "The Contributor model is launched; designers and photographers upload their resources to Reevas and Flaticon, earning an income from it",
          },
          {
            year: "2015",
    ...
    jobs: {
      ...
      team: {
        ...
        description:
          "Many people comprise our Reevas universe, forming a great unique team. They are creative, passionate, a bit geeky, and they love pizza, football and after-work gatherings.",
        items: [
          {
            title: "Innovation",
      ...
      company: {
        title: "Málaga, our HQ:",
        description:
          "Reevas Company’s office is located in downtown Málaga, a charming city with one of the best climates in Europe. Our modern facilities allow maximum comfort at work. Plenty of space, meeting rooms, leisure areas and everything needed to work in a great environment.",
        button: "Explore",
      },
      bannerBottom: {
    ...
    business: {
        ...
        items: [
          {
            ...
            description: "To ever growing Reevas Company content.",
          },
          {
      ...
      api: {
        ...
        items: ["Reevas API", "Wepik Pro", "Content Licensing", "Teams"],
      },
      form: {
    ...
    sellContent: {
      bannerTop: {
        title: "Sell photos, vectors & PSD designs on Reevas",
        description:
          "Become a Reevas contributor and make money selling your images and designs online.",
        items: [
          "Create photos, vectors, illustrations, mockups, etc. We embrace all types of creativity.",
          "Upload your graphic resources to Reevas through our intuitive and easy-to-use tool.",
          "Make money per every download your resources get. As simple as that.",
        ],
        button: "Become a contributor",
      },
      why: {
        title: "Why become a Reevas contributor?",
        items: [
          {
            title: "Stable income",
            description:
          ...
          },
          {
            ...
            description:
              "Contributors’ resources get over 75M downloads every day, making Reevas the best website for selling your photos, vector art & PSD files.",
          },
          {
      ...
      sellPhotos: {
        title: "Sell Photos",
        description:
          "Find your concept, capture it and make money selling outstanding stock photos online with Reevas.",
      ...
      community: {
        ...
        description:
          "Reevas contributor community is formed by thousands of photographers and designers from all over the world. Connect with other talented people and enjoy the benefits of our community.",
        items: [
          {
          ...
          },
          {
            ...
            description:
              "Spread the word about Reevas contributor program in your community and enjoy awesome perks.",
      ...
      stories: {
        ...
        items: [
          {
            title:
              "Reevas PROfiles: The Freelancer Life With Illustrator Alexander Gusev",
            link: "by Reevas",
          },
          {
            title:
      ...
      bannerJoin: {
        title:
          "Join now as a Reevas contributor. The world awaits your creativity",
        button: "Become a contributor",
      },
      faq: {
        qaBlock: {
          ...
          items: [
            {
              question: "What can I sell on Reevas?",
              answer:
                "On Reevas, we embrace all types of creativity. You can sell quality photographs, vectors, illustrations, mockups, and templates online once you become a Reevas contributor. Millions of users download stock content from Reevas every day, which means our site is the best place to sell your images and designs.",
            },
            {
              question: "How do I become a Reevas contributor?",
              answer:
    ...
    submitARequest: {
      ...
      form: {
        ...
        input2: "Subject",
        description1:
          "Please, enter the email address where you wish to receive our answer. If you are a registered user of Reevas, please include the email address you used when you registered if possible to help us locate your account as soon as possible.",
  ...
  footer: {
    ...
    copyright: "Copyright © 2023 Reevas",
  },
  search: {
  ...
  popupSignIn: {
    title: "Sign into your Reevas ID",
    description: "If you don't have a Reevas ID, please",
    link: "create one",
  ...
  popupSignUp: {
    title: "Create an account Reevas ID",
